...
func (m *LSystem) GetValue() []byte {
	return copyBytes(m.currentState)
}

// Returns the current length of the string generated by the L-system, in
// bytes.
func (m *LSystem) GetSize() uint64 {
	return uint64(len(m.currentState))
}
